...
public class PlayerSkeleton {
	...
	public static void main(String[] args) {
		...
		try {
			file = new  File("C:/Users/Crsytral/Desktop/GAOut.txt");
		...
		ai = new AI();
		int gameSetsCounter = 0;
		while(true){
			State s = new State();
			//new TFrame(s);
			PlayerSkeleton p = new PlayerSkeleton();
			if(gameSetsCounter==20 || gameSetsCounter==0){ //test a set of hueristic values for 20times before changing
				ai.setAIValues(p);
				gameSetsCounter = 0;
			...
			if(s.getRowsCleared()>0){
		        ...
		        String out = "You have completed "+s.getRowsCleared()+" rows.";
